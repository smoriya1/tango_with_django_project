...
def populate():
    python_pages = [
        ...
        {'title': "Learn Python in 10 Minutes",
         'url': "http://www.korokithakis.net/tutorials/python/",'views':60} ]

    django_pages = [
        {'title': "Official Django Tutorial",
         'url': "http://docs.djangoproject.com/en/1.9/intro/tutorial01/", 'views':10},
        {'title': "Django Rocks",
         'url': "http://www.djangorocks.com/", 'views':30},
        {'title': "How to Tango with Django",
         'url': "http://www.tangowithdjango.com/", 'views':60} ]

    other_pages = [
        {'title': "Bottle",
         'url': "http://bottlepy.org/docs/dev/", 'views':70},
        {'title': "Flask",
         'url': "http://flask.pocoo.org", 'views':90} ]
